...
using static CaseStudy.MyException.EnrollmentException;
using System.ComponentModel.Design;
using System.Threading.Channels;
using System.Xml.Serialization;
using static CaseStudy.MyException.MyProductException;
...
do
{
    ...
    BookType[] bookType = new BookType[]
          {
            new("Atomic Habits","James Clear",2467,2000,"yes","Non-Fiction"),
...
/*try
{
    ...
    customer11.CustomerName = "Asha";
    customer11.CustomerEmail = "asha@ust";
    Customer1.customers.Add(customer11);
    Customer1 customer12 = new Customer1();
    customer12.CustomerID = 2;
    customer12.CustomerName = "dhyan dev";
    customer12.CustomerEmail = "dhyan@ust";
    Customer1.customers.Add(customer12);
    Customer1 customer13 = new Customer1();
    customer13.CustomerID = 3;
    customer13.CustomerName = "Ra";
    customer13.CustomerEmail = "ram@ust";
    Customer1.customers.Add(customer13);

    while (true)
    {
        Console.WriteLine("*******ORDER FULLFILMENT SYSTEM***************");
